...
ActiveRecord::Schema.define(version: 2020_10_16_002453) do
  ...
  create_table "subsidiary_products", force: :cascade do |t|
    t.integer "subsidiary_id", null: false
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["product_id", "subsidiary_id"], name: "index_subsidiary_products_on_product_id_and_subsidiary_id", unique: true
    t.index ["product_id"], name: "index_subsidiary_products_on_product_id"
    t.index ["subsidiary_id"], name: "index_subsidiary_products_on_subsidiary_id"
  end
  ...
  add_foreign_key "subsidiary_products", "products"
  add_foreign_key "subsidiary_products", "subsidiaries"
end
